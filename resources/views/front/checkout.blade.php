    ...
    <div id="checkout-section" class="max-w-[1200px] mx-auto w-full flex flex-col gap-10 pb-[50px] bg-[url('assets/background/Hero-Banner.png')] bg-center bg-no-repeat bg-cover rounded-[32px] overflow-hidden">
        ...
        <div class="flex gap-10 px-[100px] relative z-10">
            <div class="w-[400px] flex shrink-0 flex-col bg-white rounded-2xl p-5 gap-4 h-fit">
                ...
                <p class="font-semibold text-[28px] leading-[42px]">Rp 250000</p>
            </div>
            <form enctype="multipart/form-data" method="POST" action="{{ route('front.checkout.store') }}" class="w-full flex flex-col bg-white rounded-2xl p-5 gap-5">
                @csrf
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <p class="font-semibold">GrowHabbits Education First</p>
