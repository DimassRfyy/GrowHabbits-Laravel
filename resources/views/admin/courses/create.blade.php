            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.courses.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="grup_wa" class="block mt-1 w-full" type="text" name="grup_wa" :value="old('grup_wa')" autofocus autocomplete="grup_wa" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="grup_discord" class="block mt-1 w-full" type="text" name="grup_discord" :value="old('grup_discord')" autofocus autocomplete="grup_discord" />
